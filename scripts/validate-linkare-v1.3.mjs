...
const checks = {
  compactTutorial: app.includes("linkare-tutorial-v2") && app.includes('compact-guided-tour'),
  paymentsView: app.includes('renderPayments()') && app.includes("['payments', 'insurance', 'Cobros'"),
