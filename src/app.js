...
const TUTORIAL_STORAGE_KEY = 'nexamind-clinical-tutorial-v1';
const TUTORIAL_VERSION = 1;

const TOUR_STEPS = [
  {
    id: 'main-navigation',
    chapter: '1 · Orientación',
    title: 'Este es su mapa principal',
    description: 'Desde esta barra puede ir a Inicio, Pacientes, Agenda, Resultados y Alertas sin perder el contexto del trabajo.',
    selector: '[data-tour="main-navigation"]',
    view: 'dashboard',
    placement: 'bottom',
    quick: true,
    icon: 'overview',
    items: ['Inicio resume lo urgente.', 'Pacientes abre los expedientes.', 'Agenda organiza las consultas.'],
    tip: 'Puede volver a Inicio en cualquier momento para retomar el panorama general.',
  },
  {
    id: 'dashboard-actions',
    chapter: '1 · Orientación',
    title: 'Dos acciones para comenzar',
    description: 'Use “Nuevo paciente” para crear un expediente y “Nueva cita” para reservar un espacio en la agenda.',
    selector: '[data-tour="dashboard-actions"]',
    view: 'dashboard',
    placement: 'left',
    quick: true,
    icon: 'plus',
    items: ['El formulario pide primero los datos esenciales.', 'Las citas pueden editarse y cambiar de estado después.'],
  },
  {
    id: 'dashboard-review',
    chapter: '1 · Orientación',
    title: 'Empiece por quien requiere revisión',
    description: 'Este indicador reúne pacientes con alertas, cambios desfavorables, baja adherencia o controles pendientes.',
    selector: '[data-tour="dashboard-review"]',
    view: 'dashboard',
    placement: 'bottom',
    quick: true,
    icon: 'alert',
    tip: 'Es una prioridad de lectura, no una orden automática ni una decisión terapéutica.',
  },
  {
    id: 'dashboard-priority',
    chapter: '1 · Orientación',
    title: 'Lista de prioridad clínica',
    description: 'Aquí aparecen primero los expedientes que conviene revisar. Cada fila muestra tratamiento, evolución y nivel de atención.',
    selector: '[data-tour="dashboard-priority"]',
    view: 'dashboard',
    placement: 'right',
    quick: false,
    icon: 'patients',
    tip: 'Abra una fila para entrar directamente al expediente del paciente.',
  },
  {
    id: 'patients-tools',
    chapter: '2 · Pacientes',
    title: 'Busque o cree un expediente',
    description: 'Puede buscar por nombre, diagnóstico o medicamento. Los filtros ayudan a ver todos, activos o pacientes por revisar.',
    selector: '[data-tour="patients-tools"]',
    view: 'patients',
    placement: 'bottom',
    quick: true,
    icon: 'search',
    items: ['La búsqueda se actualiza mientras escribe.', '“Nuevo paciente” abre un formulario sencillo.'],
  },
  {
    id: 'patient-card',
    chapter: '2 · Pacientes',
    title: 'Una tarjeta, un resumen rápido',
    description: 'Antes de abrir el expediente puede ver diagnóstico, medicamento principal, escala, mejoría observada y próxima cita.',
    selector: '[data-tour="patient-card"]',
    view: 'patients',
    placement: 'right',
    quick: true,
    icon: 'patients',
    tip: 'En el tutorial usamos datos ficticios. Haga clic en cualquier tarjeta cuando termine el recorrido.',
  },
  {
    id: 'patient-summary',
    chapter: '3 · Expediente',
    title: 'Identifique al paciente y su situación',
    description: 'El encabezado reúne diagnóstico, riesgo registrado, medicamento principal y próxima cita para evitar confusiones.',
    selector: '[data-tour="patient-summary"]',
    view: 'patient',
    patientTab: 'overview',
    placement: 'bottom',
    quick: true,
  ...
  },
  {
    id: 'patient-actions',
    chapter: '3 · Expediente',
    title: 'Las cuatro acciones de consulta',
    description: 'Desde aquí registra evolución, agrega medicamentos, cambia dosis y actualiza controles físicos.',
    selector: '[data-tour="patient-actions"]',
    view: 'patient',
    patientTab: 'overview',
    placement: 'bottom',
    quick: true,
    icon: 'activity',
    items: ['Registrar evolución actualiza escalas, adherencia y funcionamiento.', 'Cambiar dosis conserva el valor anterior y la fecha.', 'Control físico guarda peso, presión, pulso y sueño.'],
  },
  {
    id: 'patient-tabs',
    chapter: '3 · Expediente',
    title: 'El expediente está dividido en cinco partes',
    description: 'Resumen, Medicamentos, Seguimiento, Efectos y controles, e Historial. Así cada consulta tiene un camino claro.',
  ...
  {
    id: 'medication-section',
    chapter: '3 · Expediente',
    title: 'Medicamentos y cambios de dosis',
    description: 'Aquí puede agregar un tratamiento, cambiar la dosis, pausar, reactivar o finalizar un medicamento sin borrar su historial.',
    selector: '[data-tour="medication-section"]',
    view: 'patient',
    patientTab: 'medications',
    placement: 'top',
    quick: true,
    icon: 'medication',
    items: ['La dosis anterior siempre queda registrada.', 'Un paciente puede tener varios medicamentos activos.', 'El medicamento principal es solo la referencia visual del dashboard.'],
    tip: 'El sistema documenta lo ocurrido; la indicación clínica siempre corresponde al profesional.',
  },
  {
    id: 'followup-section',
    chapter: '3 · Expediente',
    title: 'Registre cómo está evolucionando',
    description: 'Seguimiento compara el valor inicial con el más reciente y permite actualizar escala, adherencia, funcionamiento, sueño y riesgo.',
    selector: '[data-tour="followup-section"]',
    view: 'patient',
    patientTab: 'followup',
    placement: 'top',
    quick: true,
    icon: 'analytics',
    tip: 'La mejoría observada describe un cambio durante el tratamiento; no prueba por sí sola qué lo causó.',
  },
  {
    id: 'safety-section',
    chapter: '3 · Expediente',
    title: 'Efectos, controles y laboratorios',
    description: 'Esta sección reúne tolerabilidad, signos vitales, sueño, laboratorios y alertas del paciente.',
    selector: '[data-tour="safety-section"]',
    view: 'patient',
    patientTab: 'safety',
    placement: 'top',
    quick: false,
    icon: 'shield',
    items: ['Registre cuándo apareció un efecto y su severidad.', 'Marque resultados fuera de rango para revisarlos.', 'Las alertas nunca cambian un medicamento automáticamente.'],
  },
  {
    id: 'timeline-section',
    chapter: '3 · Expediente',
    title: 'Toda la historia en una sola línea',
    description: 'El Historial combina medicamentos, escalas, controles, laboratorios, efectos y citas ordenados por fecha.',
    selector: '[data-tour="timeline-section"]',
    view: 'patient',
    patientTab: 'timeline',
    placement: 'top',
    quick: false,
    icon: 'clock',
    tip: 'Use los filtros para estudiar solo cambios de dosis, mediciones o eventos de seguridad.',
  },
  {
    id: 'agenda-calendar',
    chapter: '4 · Agenda',
    title: 'Organice la consulta desde el calendario',
    description: 'Cambie entre mes, semana y día. Puede crear una cita desde un día, abrirla, editarla, completar su estado o exportarla.',
    selector: '[data-tour="agenda-calendar"]',
    view: 'agenda',
    placement: 'right',
    quick: true,
    icon: 'calendar',
    items: ['Confirmada, pendiente, completada, cancelada o no asistió.', 'El archivo ICS funciona con Google, Outlook y Apple Calendar.'],
  },
  {
    id: 'results-overview',
    chapter: '5 · Revisión global',
    title: 'Resultados descriptivos de la consulta',
    description: 'Esta pantalla resume mejoría, adherencia, respuesta y seguimiento de todos los pacientes registrados.',
    selector: '[data-tour="results-overview"]',
    view: 'analytics',
    placement: 'bottom',
    quick: false,
    icon: 'trend',
    tip: 'Sirve para observar patrones de la práctica, no para comparar causalmente medicamentos.',
  },
  {
    id: 'alerts-worklist',
    chapter: '5 · Revisión global',
    title: 'Alertas que requieren lectura humana',
    description: 'Abra el paciente relacionado, revise el contexto y marque la alerta como revisada cuando corresponda.',
    selector: '[data-tour="alerts-worklist"]',
    view: 'alerts',
    placement: 'top',
    quick: true,
    icon: 'alert',
  ...
  },
  {
    ...
    description: 'Puede aumentar el texto, reducir movimiento, descargar un respaldo y volver a iniciar este tutorial.',
    selector: '[data-tour="settings-options"]',
    view: 'settings',
    placement: 'top',
    quick: false,
    icon: 'settings',
    tip: 'En esta demo los datos se guardan únicamente en el navegador donde se registran.',
  },
  {
    id: 'finish',
    chapter: 'Recorrido completado',
    title: 'Ya conoce el flujo esencial',
    description: 'Un día típico puede seguir cuatro pasos: revisar prioridades, abrir al paciente, registrar la consulta y confirmar la próxima cita.',
    selector: null,
    view: 'dashboard',
    quick: true,
    icon: 'check',
    items: ['1. Revise alertas y pacientes prioritarios.', '2. Abra el expediente.', '3. Registre evolución, dosis y controles.', '4. Programe el siguiente seguimiento.'],
    tip: 'Puede repetir este recorrido en cualquier momento desde el botón Ayuda o desde Configuración.',
  },
];
...
class App extends React.Component {
  ...
  getTourSteps = (mode = this.state.tourMode) => mode === 'quick' ? TOUR_STEPS.filter(step => step.quick) : TOUR_STEPS;
  ...
  applyTourStep = (index, mode = this.state.tourMode) => {
    ...
    const nextState = {
      ...
      appointmentDetails: null,
      modal: null,
      mobileNav: step.id === 'main-navigation' && window.innerWidth <= 880,
    };
  ...
  exitTour = () => {
    this.rememberTutorial('dismissed');
    this.setState({ tourActive: false, tourRect: null, tourReady: false, mobileNav: false }, () => this.notify('Tutorial cerrado. Puede abrirlo de nuevo desde Ayuda.', 'neutral'));
  };

  queueTourTarget = (scroll = false) => {
    clearTimeout(this.tourTargetTimer);
    this.tourTargetTimer = setTimeout(() => this.syncTourTarget(scroll), 80);
  };

  syncTourTarget = (scroll = false) => {
    if (!this.state.tourActive) return;
    const step = this.currentTourStep();
    if (!step?.selector) {
      this.setState({ tourRect: null, tourReady: true });
      return;
    }
    ...
    const measure = () => {
      ...
      this.setState({ tourRect: rect, tourReady: true });
    };
    if (scroll) {
      const settings = this.state.data.settings || {};
      target.scrollIntoView({ behavior: settings.reducedMotion ? 'auto' : 'smooth', block: 'center', inline: 'center' });
      clearTimeout(this.tourTargetTimer);
      this.tourTargetTimer = setTimeout(measure, settings.reducedMotion ? 40 : 320);
    } else {
      measure();
    }
  };
  ...
  handleTourViewportChange = () => {
    if (!this.state.tourActive) return;
    cancelAnimationFrame(this.tourViewportFrame);
    this.tourViewportFrame = requestAnimationFrame(() => this.syncTourTarget(false));
  };

  tourCardStyle = (step, rect) => {
    const viewportWidth = window.innerWidth;
    const viewportHeight = window.innerHeight;
    if (viewportWidth <= 720) {
      return { left: '16px', right: '16px', bottom: '16px', width: 'auto', top: 'auto' };
    }
    if (!rect) {
      return { left: '50%', top: '50%', width: 'min(430px, calc(100vw - 32px))' };
    }
    const cardWidth = Math.min(410, viewportWidth - 32);
    ...
    if (placement === 'auto') {
      if (space.right >= cardWidth + gap) placement = 'right';
      else if (space.left >= cardWidth + gap) placement = 'left';
      else if (space.bottom >= estimatedHeight + gap) placement = 'bottom';
      else placement = 'top';
    }
    let left;
    let top;
    if (placement === 'right' && space.right >= cardWidth + 8) {
      left = rect.left + rect.width + gap;
      top = rect.top + rect.height / 2 - estimatedHeight / 2;
    } else if (placement === 'left' && space.left >= cardWidth + 8) {
      left = rect.left - cardWidth - gap;
      top = rect.top + rect.height / 2 - estimatedHeight / 2;
    } else if (placement === 'top' && space.top >= 180) {
    ...
    top = clamp(top, 16, Math.max(16, viewportHeight - estimatedHeight - 16));
  ...
  renderGuidedTour() {
    ...
    const rect = this.state.tourRect;
    const cardStyle = this.tourCardStyle(step, rect);
    const progress = ((this.state.tourIndex + 1) / steps.length) * 100;
    return html`<div className="guided-tour" role="dialog" aria-modal="true" aria-label="Tutorial guiado"><div className="tour-click-shield" onClick=${event => event.preventDefault()}></div>${rect ? html`<div className=${`tour-spotlight ${this.state.tourReady ? 'ready' : ''}`} style=${{ top: `${rect.top}px`, left: `${rect.left}px`, width: `${rect.width}px`, height: `${rect.height}px` }}></div>` : html`<div className="tour-dim"></div>`}<aside key=${step.id} className=${`tour-card ${rect ? '' : 'tour-card-centered'}`} style=${cardStyle}><header className="tour-card-head"><div className="tour-guide"><div className="guide-orb tiny"><span></span><span></span><span></span></div><div><span>${step.chapter}</span><b>Paso ${this.state.tourIndex + 1} de ${steps.length}</b></div></div><button className="tutorial-close" aria-label="Salir del tutorial" onClick=${this.exitTour}><${Icon} name="close" size=${18}/></button></header><div className="tour-progress" aria-label=${`Progreso ${Math.round(progress)} por ciento`}><i style=${{ width: `${progress}%` }}></i></div><div className="tour-card-body"><span className="tour-step-icon"><${Icon} name=${step.icon || 'help'} size=${20}/></span><h2>${step.title}</h2><p>${step.description}</p>${step.items?.length ? html`<ul>${step.items.map(item => html`<li key=${item}><${Icon} name="check" size=${15}/><span>${item}</span></li>`)}</ul>` : null}${step.tip ? html`<div className="tour-tip"><${Icon} name="shield" size=${17}/><span>${step.tip}</span></div>` : null}</div><footer className="tour-card-footer"><button className="tour-exit" onClick=${this.exitTour}>Salir</button><div><${Button} tone="secondary" disabled=${this.state.tourIndex === 0} onClick=${this.previousTourStep}>Anterior</${Button}><${Button} icon=${isLast ? 'check' : 'chevronRight'} onClick=${this.nextTourStep}>${isLast ? 'Finalizar' : 'Siguiente'}</${Button}></div></footer><div className="tour-keyboard"><kbd>←</kbd><kbd>→</kbd> para avanzar · <kbd>Esc</kbd> para salir</div></aside></div>`;
  }
