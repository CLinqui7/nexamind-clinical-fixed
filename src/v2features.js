...
export function normalizePatientV2(patient = {}) {
  return {
    ...
    consultations: Array.isArray(patient.consultations) ? patient.consultations.map(consultation => ({
      ...
      reason: clean(consultation.reason),
      freeNotes: clean(consultation.freeNotes),
      evolution: clean(consultation.evolution),
      mentalStatus: clean(consultation.mentalStatus),
      riskAssessment: clean(consultation.riskAssessment),
      medicationNotes: clean(consultation.medicationNotes),
      intervention: clean(consultation.intervention),
      clinicalImpression: clean(consultation.clinicalImpression),
      plan: clean(consultation.plan),
      followUp: clean(consultation.followUp),
