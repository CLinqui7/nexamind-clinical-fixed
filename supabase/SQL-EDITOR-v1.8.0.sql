-- Linkare v1.8.0 - ejecutar en Supabase SQL Editor DESPUÉS de la instalación base v1.7.
-- Habilita registro self-service y cambia el precio por defecto a US$40/mes.
